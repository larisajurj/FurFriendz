...
export default function RegisterTypeScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity style={styles.button} onPress={() => router.push('/RegisterPage?userType=owner')}>
        <Text style={styles.buttonText}>Pet Owner</Text>
      </TouchableOpacity>
      <Image source={require('../assets/domnu.png')} style={styles.mainLogoDomn} />
      <TouchableOpacity style={styles.button} onPress={() => router.push('/RegisterPage?userType=sitter')}>
